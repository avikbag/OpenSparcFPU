...
#read in the sdc
source ../../dc_compiler/const/fpu.sdc

#perform timing reports
report_timing -from [all_inputs] -max_paths 35 -to [all_registers - data_pins] reports/timing.rpt
report_timing -from [all_registers -clock_pins] -max_paths 35 -to [all_registers -data_pins] reports/timing2.rpt
report_timing -from [all_registers -clock_pins] -max_paths 35 -to [all_outputs] reports/timing3.rpt
report_timing -from [all_inputs -to [all_outputs] -max_paths 35 reports/timing4.rpt
